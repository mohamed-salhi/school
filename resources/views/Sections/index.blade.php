                                                                                    ...
                                                                                    <form
                                                                                        ...
                                                                                        <div class="col">
                                                                                            <div class="multiselect">
                                                                                                <label for="inputNamee"
                                                                                                       class="control-label">المعلمين</label>
                                                                                                <div  id="checkboxes">

{{--                                                                                                    @foreach ($list_Sections->Techer as $Techer)--}}
{{--                                                                                                       {{$Techer['id']}}--}}
{{--                                                                                                    @foreach--}}
                                                                                                    @foreach ($list_Sections->Techer as $Techer2)
                                                                                                        <label for="one">
                                                                                                            <input
                                                                                                                checked   name="Teacher[]"  value="{{ $Techer2->id }}" type="checkbox" id="one"   />{{$Techer2->Name}}
                                                                                                        </label>
                                                                                                    @endforeach

                                                                                                    @foreach ($Teacher as $Techer1)

                                                                                                            <label for="one">
                                                                                                                <input
                                                                                                                         name="Teacher[]"  value="{{ $Techer1->id }}" type="checkbox" id="one"   />{{$Techer1->Name}}
                                                                                                            </label>
                                        ...
                                        <div class="col">
                                            <div class="multiselect">
                                                ...
                                                <div  id="checkboxes">
                                                    ...
                                                    @foreach ($Teacher as $Grade)
                                                        <label for="one">
                                                            <input  name="Teacher[]"  value="{{ $Grade->id }}" type="checkbox" id="one"   />{{$Grade->Name}}</label>
                                                    @endforeach
