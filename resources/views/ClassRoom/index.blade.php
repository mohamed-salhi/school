...
{{--                        @csrf--}}
{{--                        <select class="selectpicker" data-style="btn-info" name="sarech" required--}}
{{--                                onchange="this.form.submit()">--}}
{{--                            <option value="" selected disabled>{{ trans('My_Classes_trans.Search_By_Grade') }}</option>--}}
{{--                            @foreach ($Grades as $Grade)--}}
{{--                                <option value="{{ $Grade->id }}">{{ $Grade->Name }}</option> <input name="select_all"  type="checkbox"--}}
{{--                            @endforeach--}}
{{--                        </select>--}}
{{--                    </form>--}}
                        <form action="{{ route('Filter') }}" method="POST">
                        ...
                        @foreach ($Grades as $Grade)
                                    <label for="one">
                                        <input  name="sarech[]"  value="{{ $Grade->id }}" type="checkbox" id="one"   />{{$Grade->Name}}</label>
                        @endforeach

                                </div>
                            </div>
                            <button type="submit">Sarech</button>
                        </form>
